...
/**
 * This class provides an empty implementation of {@link DeliveryVisitor},
...
public class DeliveryBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements DeliveryVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
